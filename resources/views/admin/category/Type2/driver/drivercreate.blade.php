                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-3 offset-8">
                                <a href="{{ route('driver#page') }}"><button class="btn bg-dark text-white my-3">
                                        Back</button></a>
                            </div>
                        </div>
                                    ...
                                    <form action="{{ route('driver#aftercreate') }}" method="post"
                                        ...
                                        <div class="form-group p-3">
                                            <div class="mb-2">
                                                ...
                                                <input accept="image/jpeg, image/png" name="driverPhoto"
                                                    value="{{ old('driverPhoto') }}" id="image-input" type="file"
                                                ...
                                                <div class="mt-3 input-group">
                                                    <input type="text"
                                                        ...
                                                        name="driverSalary" value="{{ old('driverSalary') }}"
                                                        placeholder="salary...">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control @error('driverExperience') is-invalid  @enderror" value="" name="driverExperience" placeholder="Experience" id="experience">{{ old('driverExperience') }}</textarea>
                                                ...
                                                Skill : <br>
                                                <div class="form-floating">
                                                    <textarea name="driverSkill" class="form-control @error('driverSkill') is-invalid  @enderror" id="skill" cols="10" rows="5">{{ old('driverSkill') }}</textarea>
                                                ...
                                                <div class="mt-3 input-group">
                                                    ...
                                                    <textarea class="form-control @error('driverVaccine') is-invalid  @enderror" name="driverVaccine" aria-label="With textarea">{{ old('driverVaccine') }}</textarea>
                                                </div>
                                                @error('driverVaccine')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            @enderror
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control" value="" name="driverRemark" placeholder="" id="remark">{{ old('driverRemark') }}</textarea>
