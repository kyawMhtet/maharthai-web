                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-3 offset-8">
                                <a href="{{ route('generalworker#page') }}"><button class="btn bg-dark text-white my-3">
                                        Back</button></a>
                            </div>
                        </div>
                        <div class="col-lg-6 offset-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="{{ route('generalworker#aftercreate') }}" method="post"
                                        ...
                                        <div class="form-group p-3">
                                            <div class="mb-2">
                                                ...
                                                <input accept="image/jpeg, image/png" name="generalworkerPhoto"
                                                    value="{{ old('generalworkerPhoto') }}" id="image-input" type="file"
                                                ...
                                                <input id="cc-payment" name="generalworkerPosition" type="text" value="General Worker"
                                                ...
                                                <input id="cc-payment" name="generalworkerNationality" type="text"
                                                    value="{{ old('generalworkerNationality') }}"
                                                ...
                                                <input id="cc-payment" name="generalworkerReligion" type="text"
                                                    value="{{ old('generalworkerReligion') }}"
                                                ...
                                                <div class="mt-3 input-group">
                                                    <input type="text"
                                                        ...
                                                        name="generalworkerSalary" value="{{ old('generalworkerSalary') }}"
                                                        placeholder="salary...">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control @error('generalworkerExperience') is-invalid  @enderror" value="" name="generalworkerExperience" placeholder="Experience" id="experience">{{ old('generalworkerExperience') }}</textarea>
                                                ...
                                                Skill : <br>
                                                <div class="form-floating">
                                                    <textarea name="generalworkerSkill" class="form-control @error('generalworkerSkill') is-invalid  @enderror" id="skill" cols="10" rows="5">{{ old('generalworkerSkill') }}</textarea>
                                                ...
                                                <input id="cc-payment" name="generalworkerLanguage" type="text"
                                                    value="{{ old('generalworkerLanguage') }}"
                                                ...
                                                <div class="mt-3 input-group">
                                                    <select class="form-select" name="generalworkerStock" aria-label="Default select example">
                                                ...
                                                <div class="mt-3 input-group">
                                                    ...
                                                    <textarea class="form-control @error('generalworkerVaccine') is-invalid  @enderror" name="generalworkerVaccine" aria-label="With textarea">{{ old('generalworkerVaccine') }}</textarea>
                                                </div>
                                                @error('generalworkerVaccine')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            @enderror
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control" value="" name="generalworkerRemark" placeholder="" id="remark">{{ old('generalworkerRemark') }}</textarea>
