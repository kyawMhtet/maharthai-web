                                    ...
                                    <form action="{{ route('maid#update', $maid->id) }}" method="post"
                                        ...
                                        <div class="form-group p-3">
                                            <div class="mb-2">
                                                ...
                                                <div class="ms-3">
                                                    <div>
                                                        <select class="form-select" name="maidStock" aria-label="Default select example">

                                                            <option value="Available"
                                                            @if(old('maidStock', $maid->stockstatus) == 'Available') selected @endif>Available</option>
                                                            <option value="Not Available"
                                                            @if(old('maidStock', $maid->stockstatus) == 'Not Available') selected @endif>Not Available</option>
                                                          </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control" value="" name="maidRemark" placeholder="" id="remark">{{ old('maidRemark', $maid->remark) }}</textarea>
