                                ...
                                @foreach ($housekeepings as $housekeeping)
                                    <div class="card p-2 shadow" id="" style="width: 22rem;">
                                        <img class="card-img-top" id="card"
                                            src="{{ asset('storage/' . $housekeeping->photo) }}"
                                            style="height: auto; width: 340px;" alt="">
                                            ...
                                            <div class="housekeepinginfo">
                                                ...
                                                <div class="d-flex">
                                                    @if ($housekeeping->stockstatus == 'Available')
                                                        <p class="text-success">{{ $housekeeping->stockstatus }}</p>
                                                    @elseif ($housekeeping->stockstatus == 'Not Available')
                                                        <p class="text-danger">{{ $housekeeping->stockstatus }}</p>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <a href="{{ route('housekeeping#updatePage', $housekeeping->id) }}"
                                                class="card-link">
                                                <button class="btn btn-secondary">View More</button>
                                            </a>

                                            <a href="{{ route('housekeeping#delete', $housekeeping->id) }}"
                                                class="card-link">
