                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-3 offset-6">
                            <form action="{{ route('cashier#page') }}" method="get">
                                @csrf
                                <div class="d-flex">
                    ...
                    <button type="button" class="btn btn-primary mb-3">
                        Total - <span class="badge bg-secondary">{{ $cashiers->total() }}</span>
                    </button>
                    ...
                    <div class="container cashier-list" style="--bs-columns: 3;">
                        <div class="row" style="grid-gap: 10px;">
                            @foreach ($cashiers as $cashier)
                                <div class="card p-2 shadow" id="" style="width: 22rem;">
                                    <img class="card-img-top" id="card"
                                        src="{{ asset('storage/' . $cashier->photo) }}" style="height: auto; width: 340px;"
                                        alt="">
                                    <div class="card-body d-flex" style="justify-content: space-between">
                                        <div class="cashierinfo">
                                            <div class="d-flex">
                                                <p><b>Code# :</b></p>
                                                <p class="ms-">{{ $cashier->code }}</p>
                                            </div>

                                            <div class="d-flex">
                                                @if ($cashier->stockstatus == 'Available')
                                                    <p class="text-success">{{ $cashier->stockstatus }}</p>
                                                @elseif ($cashier->stockstatus == 'Not Available')
                                                    <p class="text-danger">{{ $cashier->stockstatus }}</p>
                                                @endif
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <p><b>{{ Str::words($cashier->note,15, '...') }}</b></p>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <a href="{{ route('cashier#updatePage', $cashier->id) }}" class="card-link">
                                            <button class="btn btn-secondary">View More</button>
                                        </a>

                                        <a href="{{ route('cashier#delete', $cashier->id) }}" class="card-link">
