                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Manager List</h2>
                        ...
                        <div class="table-data__tool-right">
                            <a href="{{ route('manager#create') }}">
                                <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                    <i class="zmdi zmdi-plus"></i>Add Manager
                                </button>
                            </a>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-3 offset-8">
                                <a href="{{ route('manager#page') }}"><button class="btn bg-dark text-white my-3">
                                        Back</button></a>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2 p-2">Manager Form</h3>
                                    </div>
                                    <hr>
                                    <form action="{{ route('manager#aftercreate') }}" method="post"
                                        ...
                                        <div class="form-group p-3">
                                            <div class="mb-2">
                                                ...
                                                <input accept="image/jpeg, image/png" name="managerPhoto"
                                                    value="{{ old('managerPhoto') }}" id="image-input" type="file"
                                                ...
                                                <input id="cc-payment" name="managerPosition" type="text" value="Manager"
                                                ...
                                                <div class="mt-3 input-group">
                                                    <input type="text"
                                                        ...
                                                        name="managerSalary" value="{{ old('managerSalary') }}"
                                                        placeholder="salary...">
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control @error('managerExperience') is-invalid  @enderror" value="" name="managerExperience" placeholder="Experience" id="experience">{{ old('managerExperience') }}</textarea>
                                                ...
                                                Skill : <br>
                                                <div class="form-floating">
                                                    <textarea name="managerSkill" class="form-control @error('managerSkill') is-invalid  @enderror" id="skill" cols="10" rows="5">{{ old('managerSkill') }}</textarea>
                                                ...
                                                <div class="mt-3 input-group">
                                                    <select class="form-select" name="managerStock" aria-label="Default select example">
                                                ...
                                                <div class="mt-3 input-group">
                                                    ...
                                                    <textarea class="form-control @error('managerVaccine') is-invalid  @enderror" name="managerVaccine" aria-label="With textarea">{{ old('managerVaccine') }}</textarea>
                                                </div>
                                                @error('managerVaccine')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            @enderror
                                                ...
                                                <div class="form-floating">
                                                    <textarea class="form-control" value="" name="managerRemark" placeholder="" id="remark">{{ old('managerRemark') }}</textarea>
