                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-3 offset-6">
                            <form action="{{ route('helper#page') }}" method="get">
                                @csrf
                                <div class="d-flex">
                    ...
                    <button type="button" class="btn btn-primary mb-3">
                        Total - <span class="badge bg-secondary">{{ $helpers->total() }}</span>
                    </button>
                    ...
                    <div class="container helper-list" style="--bs-columns: 3;">
                        <div class="row" style="grid-gap: 10px;">
                            @foreach ($helpers as $helper)
                                <div class="card p-2 shadow" id="" style="width: 22rem;">
                                    <img class="card-img-top" id="card"
                                        src="{{ asset('storage/' . $helper->photo) }}" style="height: auto; width: 340px;"
                                        alt="">
                                    <div class="card-body d-flex" style="justify-content: space-between">
                                        <div class="helperinfo">
                                            <div class="d-flex">
                                                <p><b>Code# :</b></p>
                                                <p class="ms-">{{ $helper->code }}</p>
                                            </div>

                                            <div class="d-flex">
                                                @if ($helper->stockstatus == 'Available')
                                                    <p class="text-success">{{ $helper->stockstatus }}</p>
                                                @elseif ($helper->stockstatus == 'Not Available')
                                                    <p class="text-danger">{{ $helper->stockstatus }}</p>
                                                @endif
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <p><b>{{ Str::words($helper->note,15, '...') }}</b></p>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <a href="{{ route('helper#updatePage', $helper->id) }}" class="card-link">
                                            <button class="btn btn-secondary">View More</button>
                                        </a>

                                        <a href="{{ route('helper#delete', $helper->id) }}" class="card-link">
