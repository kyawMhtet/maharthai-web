...
<div class="container-lg shadow-sm p-5 mt-5">
    <div class="row p-2 detail">
        <div class="col-12 col-xl-3 col-lg-3 col-md-2 col-sm-2   img">
            <img class="card-img-top rounded" src="{{ asset('storage/' . $housekeepings->photo) }}"
        ...
        <div class="col col-xl-8 col-lg-8 col-md-7 col-sm-5 ms-4">
            <div class="col info">
                ...
                <div class="d-flex">
                    ...
                    <div class="col">
                        <p class="ms-3">{{ old('full_part', $housekeepings->full_part) }} /
                            {{ old('live_in_out', $housekeepings->live_in_out) }}</p>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="col-10 pet-note d-flex px-4 pb-2 mb-3">
                        ...
                        <small class="shadow-sm p-2"
                            style="color: rgb(187, 45, 59);">{{ old('petNote', $housekeepings->pet_note) }}</small>
                    </div>
                </div>
