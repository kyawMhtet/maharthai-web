...
@section('title', 'General Worker Request Form')
    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-xl-6 col-lg-6 col-md-5 col-sm-12 m-auto mt-5 shadow p-5">
            ...
            <form action="https://formspree.io/f/mvoynkqy" method="POST">
                ...
                <div>
                    <p>Code*</p>
                    <input type="text" name="generalworkerCode" value="{{ old('generalworkerCode', $generalworkers->code) }}" class="form-control" placeholder="J..." disabled required>
                </div>
                <div class="mt-3">
                    <p>Name*</p>
                ...
                <div class="mt-3 text-end">
                    <a href="{{ route('generalworker#info', $generalworkers->id) }}" type="button" class="btn btn-primary">Back</a>
