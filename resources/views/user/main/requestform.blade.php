    ...
    <div class="container mt-5">
        ...
        <div class="w-50 m-auto mt-5 shadow p-5">
            ...
            <form action="https://formspree.io/f/mvoynkqy" method="POST">
                ...
                <div>
                    <p>Code*</p>
                    <input type="text" name="nannyCode" value="{{ old('nannyCode', $nannies->code) }}" class="form-control" placeholder="J..." disabled required>
                </div>
                <div class="mt-3">
                    <p>Name*</p>
                    <input type="text" name="" value="" class="form-control" placeholder="Enter Name*" required>
                </div>
