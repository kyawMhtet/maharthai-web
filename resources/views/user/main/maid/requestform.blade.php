    ...
    <div class="container mt-5">
        ...
        <div class="w-50 m-auto mt-5 shadow p-5">
            ...
            <form action="https://formspree.io/f/mvoynkqy" method="POST">
                ...
                <div>
                    <p>Code*</p>
                    <input type="text" name="maidCode" value="{{ old('maidCode', $maids->code) }}" class="form-control" placeholder="J..." disabled required>
                </div>
                <div class="mt-3">
                    <p>Name*</p>
                ...
                <div class="mt-3 text-end">
                    <a href="{{ route('mainmaid#page') }}" type="button" class="btn btn-primary">Back</a>
